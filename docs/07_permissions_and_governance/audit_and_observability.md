...
> Phase 4 [CLINE] adds per-action approval as a sibling observability pattern; Phase 6 [AUTOGPT] / [OI] will add safety-mode and budget-limit guardrails in `safety_guardrails.md`.
