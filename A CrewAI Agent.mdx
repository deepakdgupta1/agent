---
title: A CrewAI Agent
description: What an Agent is in CrewAI framework.
icon: robot
mode: "wide"
---
...
- [Context Window Management](#context-window-management)
  - [How Context Window Management Works](#how-context-window-management-works)
  - [Automatic Context Handling](#automatic-context-handling-respect_context_windowtrue)
  - [Strict Context Limits](#strict-context-limits-respect_context_windowfalse)
  - [Choosing the Right Setting](#choosing-the-right-setting)
  - [Alternative Approaches for Large Data](#alternative-approaches-for-large-data)
...
- [Direct Agent Interaction with kickoff()](#direct-agent-interaction-with-kickoff)
  - [How kickoff() Works](#how-kickoff-works)
